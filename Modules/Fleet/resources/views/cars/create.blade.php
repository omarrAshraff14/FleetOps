...
<style>
    ...
    /* Action row at bottom of sidebar */
    .sidebar-actions {
        background: var(--card-bg);
        border: 1px solid var(--border);
        border-radius: var(--radius);
    ...
    .sidebar-actions .btn-primary-fleet {
        width: 100%;
        justify-content: center;
        font-size: 14px;
        padding: 10px;
    }
    .sidebar-actions .btn-outline-fleet {
        width: 100%;
        justify-content: center;
        margin-top: 8px;
        font-size: 13px;
...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Register a vehicle, its specs, features, and initial branch assignment.</p>
    </div>
    <div class="page-actions">
        <a href="{{ route('fleet.cars.index') }}" class="btn-outline-fleet">
            <i class="bi bi-arrow-right"></i> Back
        </a>
        <button type="submit" form="createCarForm" class="btn-primary-fleet">
            <i class="bi bi-floppy"></i> Save car
        </button>
    </div>
</div>

<form id="createCarForm" method="POST" action="{{ route('fleet.cars.store') }}" enctype="multipart/form-data">
@csrf
...
<div class="create-layout">
        ...
        <div class="form-section">
            <div class="form-section-header">
                ...
                <div>
                    ...
                    <div class="section-subtitle">Unique identifiers used across the platform (BR-010).</div>
                </div>
            </div>
            <div class="form-section-body">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <span class="field-hint">Auto-generated if left empty.</span>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label class="field-label" for="color">
                        ...
                        <div class="color-row">
                            ...
                            <input type="text" id="color" name="color"
                                   ...
                                   value="{{ old('color', 'White') }}"
                                   placeholder="e.g. White, Silver">
                            <input type="hidden" name="color_hex" id="color_hex" value="{{ old('color_hex', '#ffffff') }}">
                        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                <div class="features-grid">
                    {{-- Camera --}}
                    <label class="feature-toggle" id="toggle-camera">
                        ...
                        <div class="toggle-switch">
                            <input type="checkbox" name="has_camera" id="has_camera" value="1"
                    ...
                    {{-- Sensors --}}
                    <label class="feature-toggle" id="toggle-sensors">
                        ...
                        <div class="toggle-switch">
                            <input type="checkbox" name="has_sensors" id="has_sensors" value="1"
                                   {{ old('has_sensors') ? 'checked' : '' }}>
                            <span class="toggle-track"></span>
                            <span class="toggle-thumb"></span>
                        </div>
                    </label>
                    ...
                    {{-- ABS --}}
                    <label class="feature-toggle" id="toggle-abs">
                        ...
                        <div class="toggle-switch">
                            <input type="checkbox" name="features[abs]" id="feat_abs" value="1"
                                   {{ old('features.abs') ? 'checked' : '' }}>
                            <span class="toggle-track"></span>
                            <span class="toggle-thumb"></span>
                        </div>
                    </label>
                    ...
                    {{-- GPS --}}
                    <label class="feature-toggle" id="toggle-gps">
                        ...
                        <div class="toggle-switch">
                            <input type="checkbox" name="features[gps]" id="feat_gps" value="1"
                                   {{ old('features.gps') ? 'checked' : '' }}>
                            <span class="toggle-track"></span>
                            <span class="toggle-thumb"></span>
                        </div>
                    </label>
    ...
    <div>
            ...
            <div class="sidebar-card-body">
                ...
                <div class="form-group" style="margin-bottom:12px">
                    ...
                    <select id="ownership" name="ownership" class="form-select">
                        ...
                        <option value="company" {{ old('ownership') === 'company' ? 'selected' : '' }}>Company-provided</option>
                    </select>
                </div>
                <div class="form-group" style="margin-bottom:12px">
        ...
        <div class="sidebar-card">
            <div class="sidebar-card-header">
                <div class="section-icon" style="width:30px;height:30px;font-size:14px"><i class="bi bi-info-circle"></i></div>
                <div>
                    <div class="section-title">Initial status</div>
                    <div class="section-subtitle" style="font-size:11px">Per BR-020, new cars default to Not Ready until first inspection.</div>
                </div>
            </div>
            <div class="sidebar-card-body">
                ...
                <div class="tip-box">
                    ...
                    Status transitions are audited. Any override needs a written reason.
                </div>
            </div>
        </div>
        ...
        <div class="sidebar-card">
            ...
            <div class="sidebar-card-body">
                <textarea name="notes" rows="4" class="form-textarea"
                          placeholder="Anything worth noting about this vehicle...">{{ old('notes') }}</textarea>
            </div>
        </div>
...
document.getElementById('brand_id').addEventListener('change', function () {
    ...
    allOptions
        ...
        .forEach(o => modelSel.appendChild(o.cloneNode(true)));
});

// Restore model selection on page load (after validation error)
(function () {
    const oldModel = '{{ old('car_model_id') }}';
    if (!oldModel) return;
    const opt = document.querySelector(`#car_model_id option[value="${oldModel}"]`);
...
// Init swatch from old value
(function () {
    const hex = colorHexInput.value || '#ffffff';
...
document.querySelectorAll('.feature-toggle input[type=checkbox]').forEach(function (cb) {
    ...
    function syncToggle() {
        if (cb.checked) wrapper.classList.add('is-on');
        else            wrapper.classList.remove('is-on');
    }
    syncToggle();
